    ...
    (f.event = {
        ...
        dispatch: function (c) {
            ...
            for (k = 0; k < j.length && !c.isPropagationStopped(); k++) {
                ...
                for (
                    l = 0; l < p.matches.length && !c.isImmediatePropagationStopped(); l++
                ) {
                    r = p.matches[l];
                    if (
                        h ||
...
(function (f) {
    ...
    function S() {
        for (
            var a = ["Moz", "Webkit", "Khtml", "O", "ms"], b = a.length, c = ""; b--;
            ...
            destroy: function () {
                ...
                if ("prevented" != s("destroying", this)) {
                    ...
                    for (
                        ...
                        .unbind(q.up, b.eventHandlers.touchEnd); 0 !== b.totalPages;
                        ...
                        if (
                            ...
                            ((c = b.pageObjs[a].hasClass("fixed")),
                                b.pageWrap[a].css({
                                    ...
                                    zIndex: (b.pageObjs[a].hasClass("hard") ? d.partZ[a] : d.pageZ[a]) ||
                                        (c ? -1 : 0)
                                }),
                                (c = b.pages[a]))
                        )
